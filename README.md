...
|--------------------------------------------------------|----------------------------------------|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| First Night of the Blitz (7 Sep 1940)                  | day_bomb                               | Point  | :notebook: [CSV](data/csv/day-bomb.csv), :world_map: [GeoJSON](data/geojson/day-bomb.geojson), :world_map: [GeoPackage](data/geopackage/day-bomb.gpkg)    |
| Aggregate Bomb Census points (7 Oct 1940 - 6 Jun 1941) | agg_bomb                               | Point  | :notebook: [CSV](data/csv/agg-bomb.csv), :world_map: [GeoJSON](data/geojson/agg-bomb.geojson), :world_map: [GeoPackage](data/geopackage/agg-bomb.gpkg)    |
| Aggregate Bomb Census map (7 Oct 1940 - 6 Jun 1941)    | agg_mosaic_auto_contrast_sharpen_15    | Raster | TBC                                                                                                                                                       |
| Weekly Bomb Census points (7-14 Oct 1940)              | week_bomb                              | Point  | :notebook: [CSV](data/csv/week-bomb.csv), :world_map: [GeoJSON](data/geojson/week-bomb.geojson), :world_map: [GeoPackage](data/geopackage/week-bomb.gpkg) |
